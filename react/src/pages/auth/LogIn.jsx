...
import { RiLock2Line, RiMessage2Line } from "react-icons/ri";
      ...
      <Card className="md:max-w-9/12 w-full sm:h-full overflow-y-auto z-10 relative">
        <div className="flex h-full">
          <div className="flex-1 hidden sm:block h-full">
            <img
              src="/img/Chic_and_Chill_Work_From_Home_Outfit_Ideas.jpeg"
          ...
          >
            <div className="flex justify-center w-full">
              <div className="flex flex-col items-center gap-5 w-8/12">
                ...
                <Link
                  to="/"
                  className="text-right text-sm w-full text-gray-500"
                >
                  Forgot password ?
                </Link>
                ...
                <Link to="/signup" className="text-black text-sm">
